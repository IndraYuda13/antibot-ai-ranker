...
- Add confidence calibration so low-confidence predictions can be flagged. ✅ threshold sweep v1 done; family threshold sweep v1 done; numeric feature pass done; alias feature pass done; true calibrated confidence still needs improvement.
