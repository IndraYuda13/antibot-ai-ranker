...
- Add confidence calibration so low-confidence predictions can be flagged. ✅ threshold sweep v1 done; family threshold sweep v1 done; numeric feature pass done; alias feature pass done; dev-selected gate validation done; balanced manual calibration/test split done; safety objective v1 done; true calibrated confidence still needs improvement.
